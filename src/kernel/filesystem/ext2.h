...
uint32_t ext2_get_block_group_of_inode(uint32_t inode, ext2_partition *part);
uint32_t ext2_get_index_of_inode(uint32_t inode, ext2_partition *part);
uint32_t ext2_get_block_of_inode(uint32_t inode, ext2_partition *part);
...
uint32_t ext2_find_file(char *name, uint32_t dir_inode, ext2_inode *inode, ext2_partition *part);
